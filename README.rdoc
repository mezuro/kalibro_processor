...
Kalibro Processor is a source code analysis web service. Part of the Kalibro.
...
* Services (job queues, cache servers, search engines, etc.)
  ...
  Kalibro Gatekeeper v0.1.1 (https://github.com/mezuro/kalibro_gatekeeper/releases/tag/v0.1.1)
